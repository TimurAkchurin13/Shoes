...
> Для тестирования прав администратора/менеджер/клиент можно использовать пару логин/пароль: `admin` / `1`, `manager` / `1`, `autho` / `1`
...
*   **База данных:** PgAdmin (нужно выбрать нужное)
...
*   Установленный и запущенный экземпляр PgAdmin (если используется).
